...
#define ESP_RCC       USART1
#define ESP_TX_PIN    GPIO_Pin_10   //PB10
#define ESP_TX_GPIO   GPIOB
#define ESP_RX_PIN    GPIO_Pin_11   //PB11
#define ESP_RX_GPIO   GPIOB
...
{
  ESP8266_Send_String((uint8_t *)cmd);
...
{
  ESP8266_Send_String((uint8_t *)request);
